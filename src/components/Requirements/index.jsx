      ...
      <div>
        <table className="custom-table">
          ...
          <tbody>
            ...
            <tr>
              <td className="custom-cell textAlignLeft" colSpan={3}>
                AND
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td className="custom-cell" rowSpan={6}>
                3
              </td>
              <td className="custom-cell"></td>
            ...
            <tr>
              <td className="custom-cell"></td>
              <td className="custom-cell">
                i. Patient is currently on Actemra therapy as documented by
            ...
            <tr>
              <td className="custom-cell"></td>
              <td className="custom-cell">
                ii. Patient has not received a manufacturer supplied sample at
